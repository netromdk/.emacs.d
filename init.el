...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("052b50454bdb39660eb33b89d363d064f63c6786e21755006c3a40fcc34533fd" default)))
 '(package-selected-packages
   (quote
    (projectile company use-package beacon helpful doom-modeline yasnippet-snippets flycheck-inline cargo flycheck-rust rust-mode ansi package-build shut-up epl git commander f dash s unfill comment-dwim-2 el-get flycheck-pycheckers lsp-ui company-lsp helm-xref cquery lsp-mode company-ghc hindent haskell-mode cask ert-runner diminish treemacs-projectile treemacs modern-cpp-font-lock hydra helm-flycheck zygospore windresize window-numbering vlf vkill swift-mode string-edit spaceline smartparens rainbow-mode rainbow-delimiters php-mode on-screen nlinum multiple-cursors markdown-mode magit keyfreq key-chord json-mode indent-guide highlight-thing highlight-numbers highlight-escape-sequences helm-swoop helm-projectile helm-ls-git helm-gtags helm-flx helm-c-yasnippet helm-ag golden-ratio-scroll-screen gitignore-mode gitconfig-mode git-timemachine git-messenger flyspell-lazy flycheck flx-ido fix-word find-temp-file fic-mode expand-region exec-path-from-shell dumb-jump discover-my-major dired-narrow diff-hl describe-number dashboard dash-at-point csharp-mode copy-as-format company-statistics company-flx company-c-headers cmake-mode clang-format bury-successful-compilation avy auto-dim-other-buffers auto-dictionary auto-compile anzu ace-jump-mode ace-isearch))))
