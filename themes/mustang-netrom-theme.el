...
(custom-theme-set-faces
 ...
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#F0F0F0" :weight bold))))
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#BFEBBF" :weight bold))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground "#7F9F7F" :weight bold))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground "#93E0E3" :weight bold))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground "#9FC59F" :weight bold))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground "#94BFF3" :weight bold))))
 '(rainbow-delimiters-depth-7-face ((t (:foreground "#8FB28F" :weight bold))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "#93A8D6" :weight bold))))
